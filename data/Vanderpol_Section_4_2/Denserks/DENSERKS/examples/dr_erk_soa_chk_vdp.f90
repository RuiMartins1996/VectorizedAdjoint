...
PROGRAM MAIN
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! Driver for second order adjoint of the scaled Van der Pol system
! eps = 0.01d0
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  DOUBLE PRECISION   ::  DP(P), W(P)

  INTERFACE

     SUBROUTINE INTEGRATE(N, P, Y, DY, DP, ADY,                 &
                          AD2Y, W2, TIN, TOUT,                  &
...
!   g_dfdp(1) = 0.d0
!   dfdp(1) = 0.d0
!   g_dfdp(2) = (-(g_y1(2)*1.d0/eps**2*(1-y1(1)**2)))+g_y1(1)*1.d0/eps**2*(1+2*y1(1)*y1(2))
!   dfdp(2) = (-(1.d0/eps**2))*((1.d0-y1(1)**2)*y1(2)-y1(1))
!   g_w1 = (-(g_ady1(2)*dfdp(2)))-g_ady1(1)*dfdp(1)-g_dfdp(2)*ady1(2)-g_dfdp(1)*ady1(1)
